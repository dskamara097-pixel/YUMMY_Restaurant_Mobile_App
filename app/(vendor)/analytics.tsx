...
export default function VendorAnalyticsScreen() {
  ...
  return (
    <ScreenContainer scroll contentStyle={styles.screen}>
      ...
      <View style={styles.panel}><SectionHeader title="Operational Notes" /><AppText tone="muted">Analytics are calculated locally from the restaurant's Firestore orders. Payment gateway analytics are not included in Phase 7.</AppText><AppBadge label="No payment gateway was added." tone="info" icon="card-outline" /></View>
